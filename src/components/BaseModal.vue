...
<template>
  ...
  >
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      <!-- 遮罩层 -->
      <div class="absolute inset-0 bg-surface-950/40 backdrop-blur-md" @click="handleBackdropClick"></div>

      <!-- 模态框主体 -->
      <div
          class="relative w-full glass-card p-6 rounded-3xl flex flex-col max-h-[90vh] overflow-hidden"
