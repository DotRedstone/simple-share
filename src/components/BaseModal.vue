...
<template>
  <Transition name="fade">
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-3 md:p-4 overflow-hidden">
      ...
      <div
          class="relative w-full glass-panel p-4 sm:p-6 md:p-8 rounded-2xl animate-pop-up flex flex-col max-h-[90vh] max-w-[calc(100vw-1.5rem)] md:max-w-md overflow-y-auto overflow-x-hidden"
          :class="width || ''"
      >
